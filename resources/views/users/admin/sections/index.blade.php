<x-app.admin.main-container>
    <main class="w-full flex-grow">
        <x-app.page-header :show_title="true" :title="__('Sections')">
        ...
        <x-table.wrapper>
            ...
            <x-table.body>
                {{-- <tr class="bg-white border-b">
                    <x-table.header-cell :scope="__('row')">ICT 11-A</x-table.header-cell>
                    <x-table.regular-cell>Rondina, David R. </x-table.regular-cell>
                    <x-table.regular-cell>TVL-ICT</x-table.regular-cell>
                    <x-table.regular-cell>11</x-table.regular-cell>
