            ...
            {{-- <form x-data="studentRegForm()" action="{{ route('register') }}" method="POST" class="flex flex-col gap-y-7">
                ...
                <section x-transition.duration.400ms x-claok x-show="step === 1" class="flex flex-col gap-y-4">
                    ...
                    <div>
                        ...
                        <x-form.text-input x-model="data.account.email" id="email" class="block mt-1 w-full"
                            type="email" name="email" required autocomplete="current-password"
                            placeholder="juandc@gmail.com" />

                        <p class="text-sm text-red-600"><span
                                x-text="errors.account.email ? errors.account.email : ''"></span>
                        </p>
                    ...
                    <div>
                        ...
                        <x-form.text-input x-model="data.account.password" id="password" class="block mt-1 w-full"
                ...
                <section x-transition.duration.400ms x-cloak x-show="step === 2" class="flex flex-col gap-y-4">
                    ...
                    <div class="flex gap-x-2">
                        <div class="flex-1">
                            ...
                            <x-form.text-input x-model="data.student.firstName" id="first_name"
                                class="block mt-1 w-full" type="text" name="first_name" :value="old('first_name')" required
                                autofocus autocomplete="on" placeholder="Juan" />
                        ...
                        <div class="flex-1">
                            ...
                            <x-form.text-input x-model="data.student.middleName" id="middle_name"
                                class="block mt-1 w-full" type="text" name="middle_name" :value="old('middle_name')" autofocus
                    ...
                    <div class="flex gap-x-2">
                        ...
                        <div class="flex-1">
                            ...
                            <x-form.select.select-input x-model="data.student.suffix" id="suffix"
                    ...
                    <div>
                        ...
                        <x-form.text-input x-model="data.student.lrn" id="lrn" class="block mt-1 w-full"
                            type="text" name="lrn" :value="old('lrn')" required autofocus autocomplete="on"
                            placeholder="107879070458" />
                    ...
                    <div class="flex gap-x-2">
                        ...
                        <div class="flex-1">
                            ...
                            <x-form.text-input x-model="data.student.address" id="address"
                                class="block mt-1 w-full" type="text" name="address" :value="old('address')" required
                ...
                <section x-transition.duration.400ms x-cloak x-show="step === 3" class="flex flex-col gap-y-4">
                    ...
                    <div class="flex gap-x-2">
                        <div class="flex-1">
                            ...
                            <x-form.text-input x-model="data.guardian.firstName" id="guardian_first_name"
                                class="block mt-1 w-full" type="text" name="first_name" :value="old('first_name')"
                                required autofocus autocomplete="on" placeholder="Juan" />
                        ...
                        <div class="flex-1">
                            ...
                            <x-form.text-input x-model="data.guardian.middleName" id="guardian_middle_name"
                                class="block mt-1 w-full" type="text" name="middle_name" :value="old('guardian_middle_name')"
                                autofocus autocomplete="on" placeholder="Josephito" />
                    ...
                    <div class="flex gap-x-2">
                        <div class="flex-1">
                            ...
                            <x-form.text-input x-model="data.guardian.lastName" id="guradian_last_name"
                                class="block mt-1 w-full" type="text" name="guardian_last_name" :value="old('guardian_last_name')"
                                required autofocus autocomplete="on" placeholder="Dela Cruz" />
                    ...
                    <div>
                        ...
                        <x-form.text-input x-model="data.guardian.phoneNo" id="guardian_contact_no"
                            class="block mt-1 w-full" type="text" name="contact_no" :value="old('contact_no')" required
                            autofocus autocomplete="on" placeholder="09123456789" />
                    ...
                    <div>
                        ...
                        <x-form.text-input x-model="data.guardian.email" id="email" class="block mt-1 w-full"
                            type="email" name="email" :value="old('email')" required autofocus autocomplete="on"
                ...
                return {
                    ...
                    validate() {
                        ...
                        if (this.step === 1) {
                            ...
                            console.log('fails', validation.fails()); // true
                            console.log('passes', validation.passes()); // false
                            ...
                            //     password_confirmation: validation.errors.first('password_confirmation'),
                            // }

                            // for (const key in this.errors.account) {
                            //     this.errors.account[key] = errors[key];
                            // }
                        }
                    }
                }
