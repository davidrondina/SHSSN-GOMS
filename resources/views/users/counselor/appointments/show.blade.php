<x-app.counselor.main-container>
    <x-app.page-header :show_back_btn="true" :back_btn_url="route('counselor.appointments.index')" />
            ...
            <div class="grid grid-cols-3">
                <div class="w-52 flex flex-col gap-y-2">
                    <p class="font-semibold text-gray-500">
                        {{ \Carbon\Carbon::parse($appointment->start_date)->format('l, d M Y') }}</p>
                    <p class="font-semibold">{{ \Carbon\Carbon::parse($appointment->start_date)->format('g:i A') }}</p>
                </div>
                ...
                <div class="w-52 flex flex-col gap-y-2">
                    <p class="font-semibold text-gray-500">
                        {{ \Carbon\Carbon::parse($appointment->end_date)->format('l, d M Y') }}</p>
                    <p class="font-semibold">{{ \Carbon\Carbon::parse($appointment->end_date)->format('g:i A') }}</p>
                </div>
            </div>
        </div>
